...
export class HashMap {
    ...
    */
    ...
    set(key, value) {
        ...
        // need to re-factor linked_list class to work w/nodes created here or there
        ...
        // rework to include new node structure
        ...
        // } else if (bucket.head !== null && bucket.head.value.value[0] === key) {
        //     bucket.head.value.value[1] = value;
        //     console.log(bucket.head.value.value);
